	...
	<div class="space-y-10 text-center flex flex-col items-center">
		...
		<div class="flex justify-center flex-col space-x-2">
			<h1 class="h1 text-8xl">
				<span class="bg-gradient-to-br from-blue-500 to-cyan-300 bg-clip-text text-transparent box-decoration-clone">walnuts</span>
			</h1>
			<h1 class="h1 text-8xl">
				<span class="bg-gradient-to-br from-red-500 to-yellow-500 bg-clip-text text-transparent box-decoration-clone">peanuts</span>
			</h1>
			<h1 class="h1 text-8xl">
				<span class="bg-gradient-to-br from-pink-500 to-violet-500 bg-clip-text text-transparent box-decoration-clone">pineapple</span>
			</h1>
		</div>
	</div>
</div>
